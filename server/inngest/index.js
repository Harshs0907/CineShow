...
//Inngests function to save data to a database
...
//inngest func to cancel booking after 10 minutes if payment not made

const releaseSeatsAndDeleteBooking = inngest.createFunction(
    {id: 'release-seats-delete-booking'},
    {event: "app/checkpaymnet"},
    async ({event, step})=>{
...
const sendNewShowNotifications = inngest.createFunction(
    ...
    async ({event})=>{
        ...
        for(const user of users){
            ...
            const body = `<div class="font-family: Arial, sans-serif; padding: 20px;">
                            <h2>Hi ${userName},</h2>
...
export const functions = [syncUserCreation,
    syncUserDeletion,syncUserUpdation,releaseSeatsAndDeleteBooking,sendBookingConfirmationEmail,
    sendShowReminders,
