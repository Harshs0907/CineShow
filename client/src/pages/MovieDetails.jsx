...
const MovieDetails = () => {
  ...
  const getShow = async () => {
    try {
      ...
      console.log("API Response from /api/show/:id", data);
    } catch (error) {
      console.log(error)
    }
  };
    ...
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <h1 className="text-4xl font-semibold max-w-96 text-gray-300">
            {show?.movie?.title}
          </h1>
          ...
          <div className="flex items-center flex-wrap gap-4 mt-4">
            <button
              className="flex item-center gap-2 px-7 py-3 text-sm
            ...
            <button
              ...
              className="bg-gray-700 p-2.5 rounded-full transiton cursor-pointer active:scale-95"
            >
              <Heart
                className={`w-5 h-5 ${
      ...
      <div className="flex justify-center mt-20">
        <button
         ...
         bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer"
        >
          Show More
        </button>
      </div>
